...
export default defineField({
  name: 'productLandingWithVariant',
  title: 'Product Landing with variant',
  type: 'object',
  icon: TagIcon,
  fields: [
    defineField({
    ...
    defineField({
      ...
      to: [{type: 'productMap'}],
      weak: true,
      description: 'First Product Map will be selected if left empty',
      // options: {
      //   filter: ({parent}) => {
      //     // @ts-ignore
  ...
  preview: {
    select: {
      defaultVariantTitle: 'product.mainReference.title',
      ...
      title: 'product.mainReference.title',
